...
glutWidget::glutWidget(int argc, char** argv)
{
    ...
    glutCreateWindow("ECS 175 Demo 5");
    ...
    c = new Circle(m_width/2,m_height/2,50,10); //create new circle centered at (m_width/2,m_height/2), with radius 50 and discretized by 10 segments
